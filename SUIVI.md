...
Date : 2026-07-09T18:47:20Z

Branche de travail : `docs/mcp-memory-bootstrap`.

Objectif : bootstrap Markdown MCP sans régression.
...
- préparer `.mcp/` ;
- préparer `docs/projects/` ;
- pousser une branche dédiée ;
