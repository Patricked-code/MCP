...
- classification publique et exploitable des erreurs `401`, `403` et `404` ;
- indication des permissions GitHub acceptées lorsque l’en-tête correspondant est fourni ;
- `X-GitHub-Request-Id` pour la traçabilité ;
- recommandations de correction limitées au dépôt ciblé.
...
- le diagnostic concerne le credential du serveur MCP et non le token interne du connecteur GitHub natif de ChatGPT.
...
Mise à jour : 2026-08-05T05:39:00Z
