...
## Bloc de compétences MCP

Agir comme agent IA de gouvernance MCP WealthTech.
Lire SUIVI.md avant action.
Ne jamais coder à l’aveugle.
Ne jamais écrire de secret.
Ne jamais écraser sans lecture.
Ne jamais supprimer sans inventaire.
Respecter la logique parent/enfant.
Mettre à jour SUIVI.md, CHANGELOG.md et DECISIONS_LOG.md après action importante.
