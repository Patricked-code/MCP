> # ⚠ DOCUMENT NON CANONIQUE — ARCHIVE
>
> Ce fichier est l'**archive de la révision R2**. Il n'est **plus le corps canonique** de
> l'architecture GWC et ne doit jamais être cité comme état courant.
>
> - Corps canonique courant : `docs/gwc/ARCHITECTURE_73_CONTRACTS.md` (révision R3, baseline
>   `GWC_73_CONTRACT_DESIGN_SHEETS_CANONICAL_R1`).
> - Affirmations de ce fichier explicitement remplacées : `docs/gwc/DEPRECATED_CLAIMS.md`.
> - Historique des révisions : `docs/gwc/REVISION_HISTORY.md`.
>
> Un agent qui récupère un fragment de ce fichier doit le traiter comme une **conclusion
> historique**, jamais comme une conclusion actuelle. Il est conservé pour la traçabilité de
> l'analyse et la non-régression documentaire, pas pour être appliqué.
