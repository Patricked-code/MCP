...
- Base auditée : `main`
- Ref PR : `refs/remotes/origin/pr/4`
- Merge-base : `bd8fe086b338d0dbef9515ae8dd0b8161af7ae2e`
- Head SHA : `f375a25654d314d7dc18a285c23bf23e5652ca03`
- Nombre de commits depuis merge-base : `46`
- Nombre de fichiers changés : `107`
- Stat diff : ` 107 files changed, 31726 insertions(+), 11 deletions(-)`
- merge-tree exit : `0`
...
docs/MCP_TOOLS.md
docs/PR4_PROGRESS_2026-07-08_SECRET_SAFETY.md
docs/PR4_STATIC_REVIEW.md
package.json
...
```text
 ...
 docs/MCP_TOOLS.md                                  |   68 +-
 docs/PR4_PROGRESS_2026-07-08_SECRET_SAFETY.md      |  118 +
 docs/PR4_STATIC_REVIEW.md                          |  151 +
 package.json                                       |   15 +
 ...
 src/github/errors.ts                               |   11 +
 src/github/mcpTools.ts                             |  589 ++
 src/github/registry.ts                             |   43 +-
 src/github/secretSafety.ts                         |   96 +
 ...
 src/server.ts                                      |  499 ++
 src/tools/readOnly.ts                              |   47 +
 src/tools/writeScoped.ts                           |   57 +-
 tests/githubMcpTools.test.ts                       |  111 +
 tests/onboarding.test.ts                           | 1288 +++++
 tsconfig.json                                      |    2 +-
 107 files changed, 31726 insertions(+), 11 deletions(-)
```

## Commits

```text
f375a25 docs: add PR4 secret safety progress note
96032a9 docs: mark GitHub MCP secret safety integration
d5b5b58 test: make secret detection assertions type-safe
d36b666 feat: enforce secret safety in GitHub MCP writes
ff6f744 refactor: remove circular GitHub MCP safety import
69584cc refactor: isolate GitHub MCP tool errors
8248f11 docs: document GitHub MCP secret safety hardening
d4c192b test: cover GitHub MCP secret safety helpers
6c2af50 feat: add GitHub MCP secret safety helpers
df0c5f8 docs: add PR4 static review checkpoint
dc1c459 Document controlled GitHub MCP tools
121c089 Add GitHub MCP tool safety tests
1aacf30 Register scoped-write GitHub MCP tools
e479a48 Register read-only GitHub MCP tools
dc7de7f Add controlled GitHub MCP tool helpers
...
`docs/pr-audit/PR-4.merge-tree.txt`
